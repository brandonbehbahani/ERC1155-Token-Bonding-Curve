...
contract BancorFormula is Power {
  ...
  */
  function calculatePurchaseReturn(uint256 _supply, uint256 _connectorBalance, uint32 _connectorWeight, uint256 _depositAmount) public returns (uint256) {
    // validate input
  ...
  */
  function calculateSaleReturn(uint256 _supply, uint256 _connectorBalance, uint32 _connectorWeight, uint256 _sellAmount) public returns (uint256) {
    // validate input
